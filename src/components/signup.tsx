    ...
    <section className="flex flex-col justify-center items-center h-[70vh]">
      ...
      className="  w-[45%] p-5 rounded-md xl:w-[20%] h-[30%] flex items-center flex-col pl-[40px] pr-[40px] ">
        ...
        <div className="flex flex-col m-2 w-full">
          ...
          {
            !validName && nameFocus ? <p className="errmsg text-[0.8rem] mb-1 text-red-500" aria-live="assertive">Invalid name</p> : null
          }
          <input
        ...
        <div className="flex flex-col m-2 w-full">
          <label className="font-extralight xl:font-light mb-1" htmlFor="email">
            Email
          </label>
          {
            !validEmail && emailFocus ? <p className="errmsg text-[0.8rem] mb-1 text-red-500" aria-live="assertive">Invalid email</p> : null
          }
          <input
            className="border border-gray-300  h-9 pl-2 rounded-md font-light text-sm  outline-none focus:border-blue-300 focus:ring-4 ring-blue-500/20  transition-all ease-in-out "
            type="email"
        ...
        <div className="flex flex-col m-2 w-full">
          <label className="font-extralight xl:font-light mb-1 " htmlFor="password">
            Password
          </label>
          {
            !validPassword && passwordFocus ? <p className="errmsg text-[0.8rem] mb-1 text-red-500" aria-live="assertive">Invalid password</p> : null
          }
          <input
        ...
        <div className="flex flex-col m-2 w-full">
          <label className="font-extralight xl:font-light mb-1 " htmlFor="confirmPassword">
           Confirm Password
          </label>
          {
            !validconfirmPassword && confirmPasswordFocus ? <p className="errmsg text-[0.8rem] mb-1 text-red-500" aria-live="assertive">Password does not match</p> : null
          }
          <input
            className="border border-gray-300 outline-none h-9 pl-2 rounded-md font-light text-sm focus:border-blue-300 focus:ring-4 ring-blue-500/20  transition-all ease-in-out"
            type="password"
        ...
        <div className="flex flex-col m-2 w-full">
          <label className="font-extralight xl:font-light mb-1 " htmlFor="country">
            Country
          </label>
          {
            !validCountry && countryFocus ? <p className="errmsg text-[0.8rem] mb-1 text-red-500" aria-live="assertive">Invalid country</p> : null
          }
          <input
            className="border border-gray-300 outline-none h-9 pl-2 rounded-md font-light text-sm focus:border-blue-300 focus:ring-4 ring-blue-500/20  transition-all ease-in-out"
            type="text"
        ...
        <button
          ...
          type="submit"
          disabled={!validName || !validEmail || !validCountry || !validPassword || !validconfirmPassword  ? true : false}
        >
          Sign Up
        </button>

        {
         success ? <p className="font-extralight text-md mt-4">Registration successful</p> : null
        }
